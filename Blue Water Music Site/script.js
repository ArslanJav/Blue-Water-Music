...
// video plays add border 2px solid #D81E5B and when paused remove the border from the video and add it to back when playing

var videos = document.querySelectorAll("video");
videos.forEach((video) => {
  video.addEventListener("play", () => {
    video.style.border = "5px solid #D81E5B";
  });
